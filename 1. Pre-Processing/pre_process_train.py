...
path="E:\Storage Access\Workspaces\AMEX\TextCNN\Datasets\Train\input"
os.chdir(path)
...
path2="E:\Storage Access\Workspaces\AMEX\TextCNN\Datasets\Train\Output"
os.chdir(path2)
#print(os.listdir())
...
path3="E:\Storage Access\Workspaces\AMEX\TextCNN"
os.chdir(path3)
